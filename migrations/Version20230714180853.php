 ...
 */
final class Version20230714180853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_group (id INT AUTO_INCREMENT NOT NULL, domain_group_id INT DEFAULT NULL, name VARCHAR(512) NOT NULL, UNIQUE INDEX UNIQ_7E954D5BEDDA9608 (domain_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
